...
const HomeCard4 = () => {
  ...
  return (
    <div className="relative p-4 md:p-10 flex items-center justify-center min-h-screen bg-[#0d0f1b]">
      {/* Particle effect component as a full-screen background */}
      <div className="absolute inset-0 z-0">
        
      </div>

      {/* Main content container with backdrop-filter */}
      <div style={mainContainerStyle} className="relative main-container max-w-7xl w-full p-4 md:p-8 rounded-3xl grid grid-cols-1 gap-8 z-10">
        {/* Top Section */}
          ...
          <div className="flex flex-col">
            <div style={cardStyle} className="card rounded-xl overflow-hidden shadow-lg p-6">
              ...
              <div className="mt-4 space-y-2">
                ...
                <input type="text" placeholder="Name" className="w-full p-2 rounded-md bg-gray-800 text-white text-sm" />
                <input type="text" placeholder="Product Number" className="w-full p-2 rounded-md bg-gray-800 text-white text-sm" />
                <input type="text" placeholder="Product Title" className="w-full p-2 rounded-md bg-gray-800 text-white text-sm" />
                <textarea placeholder="Product Description" className="w-full p-2 rounded-md bg-gray-800 text-white text-sm h-20"></textarea>
              </div>
            </div>
          </div>
        </div>
